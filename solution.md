...
- Команда `top` выводит на экран:
  ...
  - загрузка cpu - 0.0 %;
  - загрузка памяти - 187.2 из 3919.5;
  - pid процесса занимающего больше всего памяти - 1;
  - pid процесса, занимающего больше всего процессорного времени - 2081 и 2194 <br>
...
- Выполним команду:
    ...
    >Для корневого раздела (/):\
        ...
        - Размер занятого пространства: 5697776;\
        - Размер свободного пространства: 5441876;\
...
- Выполним команду:
    ...
    >Для корневого раздела (/):\
        - Размер раздела: 12;\
        - Размер занятого пространства: 5.5Гб;\
        - Размер свободного пространства: 5.2Гб;\
        - Процент использования: 52  %;\
...
- Время последней успешной авторизации: may 25 19:37:38
